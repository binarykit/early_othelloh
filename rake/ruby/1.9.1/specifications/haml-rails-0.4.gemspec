...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<haml>, [">= 3.1", "< 4.1"])
      s.add_runtime_dependency(%q<activesupport>, [">= 3.1", "< 4.1"])
      s.add_runtime_dependency(%q<actionpack>, [">= 3.1", "< 4.1"])
      s.add_runtime_dependency(%q<railties>, [">= 3.1", "< 4.1"])
      s.add_development_dependency(%q<rails>, [">= 3.1", "< 4.1"])
      s.add_development_dependency(%q<bundler>, ["~> 1.2"])
      s.add_development_dependency(%q<rake>, [">= 0"])
    else
      s.add_dependency(%q<haml>, [">= 3.1", "< 4.1"])
      s.add_dependency(%q<activesupport>, [">= 3.1", "< 4.1"])
      s.add_dependency(%q<actionpack>, [">= 3.1", "< 4.1"])
      s.add_dependency(%q<railties>, [">= 3.1", "< 4.1"])
